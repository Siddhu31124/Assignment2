export const homeNavStyle =
  "w-[screen] px-40 py-6 gap-10 bg-stone-900 flex flex-row items-center";
export const profileCircleStyle =
  "h-16 w-16 text-2xl bg-blue-200  text-white flex justify-center items-center rounded-full";
export const leadDataBlockStyle =
